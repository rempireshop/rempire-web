...
function routes(): RouteCase[] {
  ...
  return [
    ...
    { name: "PATCH /api/admin/orders/[id]/", path: "/api/admin/orders/x/", method: "PATCH", exports: ["GET", "PATCH"], load: () => import("@/app/api/admin/orders/[id]/route"), auth: "admin", req: admin, params: { id: "" }, body: { status: "paid", note: "ok" } },
    ...
    { name: "GET /api/admin/customers/", path: "/api/admin/customers/", method: "GET", exports: ["GET"], load: () => import("@/app/api/admin/customers/route"), auth: "admin", req: admin, queries: [...PAGINATION, "?tier=pro", "?tier=nonsense", "?format=csv", "?q=%00"], jsonBody: false },
