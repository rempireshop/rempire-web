...
const T: Record<Lang, Strings> = {
  ru: {
    ...
    preheader: "Код внутри. Действует на всё в магазине, без срока.",
    ...
    how: "Картой можно оплатить любой товар в магазине — целиком или частично. Остаток сохраняется на карте до следующего заказа. Срок действия не ограничен.",
    cta: "Выбрать подарок",
  ...
  et: {
    ...
    preheader: "Kood on kirjas. Kehtib kogu poe kaubale, tähtajatult.",
    title: "Kinkekaart",
    ...
    how: "Kaardiga saab tasuda iga poe toote eest — kas kogu summa või osa sellest. Jääk jääb kaardile järgmise tellimuse jaoks. Kehtivusaeg on piiramata.",
    cta: "Vali kingitus",
  ...
  en: {
    ...
    preheader: "The code is inside. Valid on everything in the shop, no expiry.",
    title: "Gift card",
    ...
    how: "The card pays for any product in the shop, in full or in part. Whatever is left stays on the card for your next order. It never expires.",
    cta: "Choose a gift",
