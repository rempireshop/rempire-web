...
- "tags": the same tags, translated as short lowercase words a reader in ${LANG_NAME[lang]} would search for. EVERY tag in ${LANG_NAME[lang]} and no other language; a brand name stays as it is spelt.
