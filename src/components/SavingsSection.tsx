...
const NEW = [
  ...
  { name: "Montonio: абонплата + комиссии", cost: "≈ 45 €" },
];
  ...
  return (
    <section data-fb="Стоимость" className="border-t-2 border-ink pt-5">
      ...
      <div className="mt-6 space-y-3 leading-relaxed">
        <p>
          Экономия — примерно{" "}
          <strong>50–150 € в месяц (600–1 800 € в год)</strong>, в зависимости
          от того, сколько приложений подключено сейчас. Хостинг сайта может
          быть вообще бесплатным (Cloudflare) — 17 € появляются, только если
          остаёмся на Vercel, чей бесплатный план запрещает коммерцию.
        </p>
        <p>
