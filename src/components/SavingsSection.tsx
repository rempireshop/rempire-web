...
const NEW = [
  ...
  { name: "Montonio: абонплата + комиссии", cost: "≈ 32–83 €" },
];
  ...
  return (
    <section data-fb="Стоимость" className="border-t-2 border-ink pt-5">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        ...
        <div className="border-2 border-ink bg-ink p-4 text-paper">
          ...
          <p className="mt-1 text-xs text-paper/70">
            40 € — если большинство платит банковской ссылкой; 115 € — если
      ...
      <div className="mt-6 space-y-3 leading-relaxed">
        <p>
          Экономия зависит от того, чем платят клиенты. Если всё останется на
          картах — разница небольшая. Если люди начнут платить банковскими
          ссылками (а в Эстонии их любят) — экономия доходит до{" "}
          <strong>~150 € в месяц</strong>. Каждая оплата через банк стоит нам
          5 центов вместо процента с суммы.
        </p>
        <p>
