      ...
      <main className="mx-auto max-w-2xl space-y-14 px-5 pb-28 pt-10">
        ...
        >
          <p>
            ...
            Всё, что ты просил, — внутри: баннер-слайдер, блок новинок,
            логотипы способов оплаты, каталог без страниц (товары
            подгружаются сами), понятное оформление заказа и самовывоз с
            Mardi 1.
          </p>
          <p className="text-fog">
            Лучше открыть и с компьютера, и с телефона — вёрстка разная. Если
            что-то не нравится, жми 💬 прямо там.
          </p>
        </Card>
