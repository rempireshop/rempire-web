...
| GSC_SERVICE_ACCOUNT_JSON / GSC_SITE_URL | Search Console data in admin «Аналитика» (service account added as a GSC user; site `sc-domain:rempireshop.com`) — see docs/analytics.md | Dmitri | ⬜ |
