...
const INTENTIONAL = [
  ...
  [/^(товар|товара|товаров|точка|точки|точек|раздел|раздела|разделов|заказ|заказа|заказов|балл|балла|баллов|слайд|слайда|слайдов|день|дня|дней|фотография|фотографии|фотографий|использование|использования|использований|своих текста|своих текстов|заявка|заявки|заявок|отзыв|отзыва|отзывов|статья|статьи|статей|черновик|черновика|черновиков|требует внимания|требуют внимания)$/,
